            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><center>Login Sihana PEMUKA</h3>
                    </div>
                        ...
                        <form role="form" action="<?php echo base_url(); ?>login" method="post">
                            <fieldset>
                                <div class="form-group">
                                  ...
                                  <input class="form-control" placeholder="Username"  name="username" value="<?php echo $username; ?>" type="username" autofocus required>
